...
class VerificationApi:
    ...
    def get_verify_omex(
        ...
        _param = self._get_verify_omex_serialize(
    ...
    @validate_call
    def get_verify_omex_with_http_info(
        self,
        workflow_id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OmexVerifyWorkflowOutput]:
        """Retrieve verification report for OMEX/COMBINE archive
    ...
    @validate_call
    def get_verify_omex_without_preload_content(
        self,
        workflow_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_verify_omex_serialize(
        self,
        workflow_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/verify_omex/{workflow_id}",
    ...
    def get_verify_runs(
        ...
        _param = self._get_verify_runs_serialize(
            workflow_id=workflow_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_verify_runs_with_http_info(
        self,
        workflow_id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RunsVerifyWorkflowOutput]:
        """Get verification report for biosimulation runs
    ...
    @validate_call
    def get_verify_runs_without_preload_content(
        self,
        workflow_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_verify_runs_serialize(
        self,
        workflow_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/verify_runs/{workflow_id}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def start_verify_omex(
        ...
        rel_tol: Annotated[
            ...
            Field(description="Relative tolerance to use for proximity comparison."),
        ] = None,
        abs_tol: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
            Field(description="Absolute tolerance to use for proximity comparison."),
        ] = None,
        ...
        :param rel_tol: Relative tolerance to use for proximity comparison.
        :type rel_tol: float
        :param abs_tol: Absolute tolerance to use for proximity comparison.
        :type abs_tol: float
        ...
        _param = self._start_verify_omex_serialize(
    ...
    @validate_call
    def start_verify_omex_with_http_info(
        self,
        uploaded_file: Annotated[
            Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]],
            Field(description="OMEX/COMBINE archive containing a deterministic SBML model"),
    ...
    @validate_call
    def start_verify_omex_without_preload_content(
        self,
        uploaded_file: Annotated[
            Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]],
            Field(description="OMEX/COMBINE archive containing a deterministic SBML model"),
    ...
    def _start_verify_omex_serialize(
        self,
        uploaded_file,
        workflow_id_prefix,
        simulators,
        ...
        if abs_tol is not None:
            _query_params.append(("abs_tol", abs_tol))
    ...
    def start_verify_runs(
        ...
        _param = self._start_verify_runs_serialize(
            workflow_id_prefix=workflow_id_prefix,
    ...
    @validate_call
    def start_verify_runs_with_http_info(
        self,
        workflow_id_prefix: Annotated[Optional[StrictStr], Field(description="Prefix for the workflow id.")] = None,
        biosimulations_run_ids: Annotated[
            Optional[List[StrictStr]], Field(description="List of biosimulations run IDs to compare.")
    ...
    @validate_call
    def start_verify_runs_without_preload_content(
        self,
        workflow_id_prefix: Annotated[Optional[StrictStr], Field(description="Prefix for the workflow id.")] = None,
        biosimulations_run_ids: Annotated[
            Optional[List[StrictStr]], Field(description="List of biosimulations run IDs to compare.")
    ...
    def _start_verify_runs_serialize(
        self,
        workflow_id_prefix,
