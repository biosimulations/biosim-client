...
class OmexVerifyWorkflowOutput(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of workflow_input
        if self.workflow_input:
            _dict["workflow_input"] = self.workflow_input.to_dict()
        # override the default output from pydantic by calling `to_dict()` of each item in actual_simulators (list)
        _items = []
        if self.actual_simulators:
            for _item_actual_simulators in self.actual_simulators:
                if _item_actual_simulators:
                    _items.append(_item_actual_simulators.to_dict())
            _dict["actual_simulators"] = _items
        ...
        # set to None if actual_simulators (nullable) is None
        # and model_fields_set contains the field
        if self.actual_simulators is None and "actual_simulators" in self.model_fields_set:
            _dict["actual_simulators"] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "workflow_input": OmexVerifyWorkflowInput.from_dict(obj["workflow_input"])
            if obj.get("workflow_input") is not None
            else None,
            "workflow_status": obj.get("workflow_status"),
            "timestamp": obj.get("timestamp"),
            "actual_simulators": [BiosimSimulatorSpec.from_dict(_item) for _item in obj["actual_simulators"]]
            if obj.get("actual_simulators") is not None
            else None,
            "workflow_run_id": obj.get("workflow_run_id"),
            "workflow_results": GenerateStatisticsOutput.from_dict(obj["workflow_results"])
