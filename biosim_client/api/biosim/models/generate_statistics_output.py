...
class GenerateStatisticsOutput(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["sims_run_info", "all_dataset_vars", "comparison_statistics", "sim_run_data"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in all_dataset_vars (list)
        _items = []
        if self.all_dataset_vars:
            for _item_all_dataset_vars in self.all_dataset_vars:
                if _item_all_dataset_vars:
                    _items.append(_item_all_dataset_vars.to_dict())
            _dict["all_dataset_vars"] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "all_dataset_vars": [DatasetVar.from_dict(_item) for _item in obj["all_dataset_vars"]]
            if obj.get("all_dataset_vars") is not None
            else None,
