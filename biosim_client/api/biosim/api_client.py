...
import biosim_client.api.biosim.models
from biosim_client.api.biosim import rest
from biosim_client.api.biosim.api_response import ApiResponse
from biosim_client.api.biosim.api_response import T as ApiResponseT
from biosim_client.api.biosim.configuration import Configuration
from biosim_client.api.biosim.exceptions import (
    ApiException,
    ApiValueError,
)
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(biosim_client.api.biosim.models, klass)
